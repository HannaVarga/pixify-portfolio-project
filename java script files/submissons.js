  ...
  return `
    <div class="submission-card">
        <a href="../html files/details page.html?name=${name}">
            <img class="submission-card-image" src="${image}" alt="${title}"/>
...
const toggleTheme = () => {
  ...
  if (body.style.backgroundColor === "rgb(42, 59, 73)") {
    ...
    pictureContainer.querySelector(
      ".submissons-picture-container"
    ).style.color = "rgba(123, 255, 233)";
  } else {
